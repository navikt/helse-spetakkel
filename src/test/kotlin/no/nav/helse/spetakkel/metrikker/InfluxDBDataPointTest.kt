...
class InfluxDBDataPointTest {

    @Test
    fun `should handle complex tags and fields`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf(
    ...
    fun `should handle field with string value`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to "val"))
    ...
    fun `should handle field with string value with quote`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to "val \"foo\""))
    ...
    fun `should handle field with comma in key`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("key1,2" to "val2"))
    ...
    fun `should handle tags with comma in key`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to "val1"), mapOf("key1,2" to "val2"))
    ...
    fun `should handle tags with comma in value`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to "val1"), mapOf("key1" to "val2,val3"))
    ...
    fun `should handle field with int value`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to 1))
    ...
    fun `should handle field with double value`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to 1.0))
    ...
    fun `should handle field with boolean false value`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to false))
    ...
    fun `should handle field with boolean true value`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to true))
    ...
    fun `should send event with tags`() {
        val dataPoint = InfluxDBDataPoint("myEvent", mapOf("field" to "val1"), mapOf("tag" to "val2"))
